...
How to RUN:
The first input is the output file from processMarvel.py which is "BFS-iteration-0.txt"

1pass:
!python BFSIteration.py --target=100 BFS-iteration-0.txt > BFSIteration-out.txt
NOT YET FOUND NO LOG
SO THIS OUTPUT WILL BE PASSED AS INPUT FOR NEXT TIME--
2pass:
!python BFSIteration.py --target=100 BFSIteration-out.txt > BFSIteration-out2.txt
NOT YET FOUND NO LOG
SO THIS OUTPUT WILL BE PASSED AS INPUT FOR NEXT TIME--
3pass
!python BFSIteration.py --target=100 BFSIteration-out2.txt > BFSIteration-out3.txt
 observed in console:
    Running step 1 of 1...
    Counters: 1
            Degrees of Separation
                    Target ID 100 was hit with distance 3=5
    Counters: 1
            Degrees of Separation
                    Target ID 100 was hit with distance 3=5
